package inu.appcenter.bjj_android.feature.profile.presentation.setting.service
...
private fun ParsedTermsContent() {
    Column(
        ...
        MainSection("제 1 조 [목적]")
        NormalText(" 본 약관은 밥점줘 앱을 통해 제공되는 리뷰 작성, 포인트 적립 및 아이템 뽑기 기능 등 일체의 서비스 이용에 관한 조건과 절차를 명시합니다.")

        MainSection("제 2 조 [이용계약의 성립]")
        SubItem("a. 회원 가입 후 본 약관에 동의함으로써 이용 계약이 체결됩니다.")
        ...
        MainSection("제 8 조 [문의사항]")
        SubItem("a. 이메일: highyun3269@gmail.com")
